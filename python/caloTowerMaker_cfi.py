...
caloTowerMaker = cms.EDProducer("CaloTowerMaker",
   ...
   hbheRecHitsInputTag= cms.InputTag("hbhereco"),
   hfRecHitsInputTag  = cms.InputTag("hfreco"),
   threshHcal     = cms.double(5.),							  
   threshEt       = cms.double(5.), #gev, for reading out ecal flags, time, etc
